...
module internal Utils = 
    ...
    let toTorchType dtype =
        ...
        | Dtype.Sym _ -> failwith "symbolic requires Backend.Symbolic"
...
type TorchRawTensor(tt: TorchTensor, shape: Shape, dtype: Dtype, device: Device) =
    ...
    override _.Nelement = Dim (shapeLength shape.Values)
    ...
    override t.ComputeHash() = 
        ...
        let n = Shape.nelements shape |> Dim.eval
        match dtype with 
        | Dtype.Int8 ->
    ...
    override t1.AddTTSlice(location:Dim[], t2) =
    ...
    override t1.MaxUnpool1D(indices, outputSize) = 
        ...
        let resulttX = t1X.MaxUnpool2D(indicesX, [| outputSize.[0]; outputSize.[1]; Dim 1; outputSize.[2] |])
    ...
    override t1.MaxUnpool2D(indices, outputSize) = 
        ...
        let outputSize = outputSize.[2..3] |> Dims.eval
    ...
    override t1.MaxUnpool3D(indices, outputSize) = 
        ...
        let outputSize = outputSize.[2..4] |> Dims.eval
